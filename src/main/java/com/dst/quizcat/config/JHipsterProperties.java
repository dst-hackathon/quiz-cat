...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "quizcat@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "quizcat API";

        private String description = "quizcat API documentation";
