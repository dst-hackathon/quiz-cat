...
class QuestionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Question entity")
        ...
        .repeat(2) {
            ...
            .post("/api/questions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "summary":"SAMPLE_TEXT", "description":null, "objective":"SAMPLE_TEXT", "keyAnswer":"SAMPLE_TEXT", "answerSize":null, "answerDescription":"SAMPLE_TEXT", "expectedTime":null}""")).asJSON
            .check(status.is(201))
