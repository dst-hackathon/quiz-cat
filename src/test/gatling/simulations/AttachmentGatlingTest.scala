...
class AttachmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Attachment entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "imagePath":"SAMPLE_TEXT", "image":null, "attachmentPath":"SAMPLE_TEXT", "attachment":null, "contentType":"SAMPLE_TEXT", "comment":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
