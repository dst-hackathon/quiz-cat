...
describe('Label e2e test', () => {
    ...
    it('should load Labels', async () => {
        ...
        expect(await labelComponentsPage.getTitle()).to.eq('quizcatApp.label.home.title');
    });

    it('should load create Label page', async () => {
        await labelComponentsPage.clickOnCreateButton();
        labelUpdatePage = new LabelUpdatePage();
        expect(await labelUpdatePage.getPageTitle()).to.eq('quizcatApp.label.home.createOrEditLabel');
    ...
    it('should create and save Labels', async () => {
        ...
        await labelComponentsPage.clickOnCreateButton();
        await promise.all([labelUpdatePage.setTextInput('text'), labelUpdatePage.parentSelectLastOption()]);
        expect(await labelUpdatePage.getTextInput()).to.eq('text');
    ...
    it('should delete last Label', async () => {
        ...
        expect(await labelDeleteDialog.getDialogTitle()).to.eq('quizcatApp.label.delete.question');
