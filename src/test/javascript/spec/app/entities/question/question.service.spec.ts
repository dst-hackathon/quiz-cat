...
import { IQuestion, Question, AnswerSize } from 'app/shared/model/question.model';
...
describe('Service Tests', () => {
    describe('Question Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Question(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', AnswerSize.XS, 'AAAAAAA', 0);
        });
